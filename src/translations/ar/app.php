...
return [
    ...
    'Choose colors which should be recommended by the color picker.' => 'اختر الألوان التي ينبغي أن يقترحها منتقي الألوان.',
    ...
    'Couldn’t send activation email.' => 'تعذَّر إرسال رسالة البريد الإلكتروني للتنشيط.',
    ...
    'How should {type} slugs be translated?' => 'كيف ينبغي ترجمة مسارات {type}؟',
    ...
    'Send an activation email now' => 'إرسال رسالة تنشيط الآن',
    ...
    'Template that defines the Slug field’s custom “translation key” format. {type} slugs will be copied to all sites that produce the same key. For example, to make slugs translatable based on the first two characters of the site handle, you could enter `{site.handle[:2]}`.' => 'قالب يحدد تنسيق "مفتاح الترجمة" المخصَّص لحقل المسار. سيتم نسخ مسارات {type} إلى جميع المواقع التي تنتج المفتاح نفسه. على سبيل المثال، لجعل المسارات قابلة للترجمة حسب أول حرفين من مؤشر الموقع، يمكنك إدخال `{site.handle[:2]}`.',
